                        ...
                        {user.map((user) => (
                            <Table.Body className='divide-y' key={user._id}>
                                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                                    ...
                                    <Table.Cell><span className='font-medium text-red-500 hover:underline cursor-pointer' onClick={() => { setShowModal(true); setDeleteUserId(user._id); }}>Delete</span> </Table.Cell>
                                </Table.Row>
                            </Table.Body>
                        ))
                        }

          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-3">
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link href="http://www.gazal.lovestoblog.com">
                  My Cv Website
                </Footer.Link>
                <Footer.Link href="/about">Gazal's Blog</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
              <Footer.Title title="Follow us" />
              <Footer.LinkGroup col>
                <Footer.Link href="https://www.github.com/gazalkagdi">
                  Github
                </Footer.Link>
                <Footer.Link href="https://www.linkedin.com/in/gazalkagdi">
                  LinkedIn
                </Footer.Link>
              </Footer.LinkGroup>
            </div>
